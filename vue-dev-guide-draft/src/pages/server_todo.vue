    ...
    <div class="flex px-mx-auto">
      ...
      <div class="second-wrap relative">
        <div class="header flex font-mono justify-center justify-between">
          ...
          <button class="icon-btn mx-2 !outline-none " @click="deleteDone(todo)">
            ...
            <ul>
              <li v-for="todo in todoList" :key="`todo-userId-${todo.userId}`" class="flex">
                ...
                <div v-else class="mt-2 ml-4">
                  <span>{{ todo.text }}</span>
                  <button class="icon-btn mx-2 !outline-none absolute right-7 mt-1" @click="choiceUpdateTodo(todo)">
                    <div i="carbon-edit" />
                  </button>
                  <button class="icon-btn mx-2 !outline-none absolute right-0 mt-1" @click="deleteTodo(todo)">
                    <div i="carbon-close" />
                  </button>
                </div>
              </li>
